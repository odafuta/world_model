...
# -*- coding: utf-8 -*-
"""
MATWM Training Script with use_gamma_progress=True (TEST VERSION)
...
print('=' * 70)
print('MATWM + Curiosity-Driven Training (γ-Progress=TRUE) - TEST VERSION')
print('=' * 70)
...
LOG_DIR = 'llm_logs_gamma_true_test'
...
# ============================================================
def train_matwm_with_curiosity(config, curiosity_config, save_dir='results_gamma_true_test', resume_from=None):
...
if __name__ == '__main__':
    ...
    agents, episode_rewards, training_metrics, episode_curiosity, curiosity_metrics = \
        train_matwm_with_curiosity(config, curiosity_config, save_dir='results_gamma_true_test')
