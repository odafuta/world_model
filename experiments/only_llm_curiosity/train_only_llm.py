...
# -*- coding: utf-8 -*-
"""
MATWM Training Script: Only LLM Curiosity (γ-Progress disabled)
実験メソッド: only_llm_curiosity
"""
...
config = MATWMConfig(
    ...
    log_interval=100,
    save_interval=1000,
    use_gamma_progress=False,  # γ-Progress disabled
)
