...
# -*- coding: utf-8 -*-
"""
MATWM Training Script with use_gamma_progress=True
...
config = MATWMConfig(
    ...
    log_interval=100,
    save_interval=1000,
    use_gamma_progress=True,  # ★ TRUE for this script
)
...
# Training Function
# ============================================================
def train_matwm_with_curiosity(config, curiosity_config, save_dir='results_gamma_true', resume_from=None):
    """
    MATWM + Curiosity-driven training with γ-Progress
    ...
    # Shared World Model (γ-Progress enabled)
